...
const renderLicenseSection = license => {
  if (data.license === 'MIT') {
    return `
    This project is licensed under the MIT license. To abtain a copy of the license, visit:
    
    ${renderLicenseLink(license)}`;

  } else if (data.license === 'Apache 2.0') {
    return `
    This project is licensed under the Apache 2.0 license. To abtain a copy of the license, visit:
    
    ${renderLicenseLink(license)}`;

  } else if (data.license === 'BSD 3-Clause') {
    return `
    This project is licensed under the BSD 3-Clause license. To abtain a copy of the license, visit:
    
    ${renderLicenseLink(license)}`;

  } else if (data.license === 'GNU GPLv3'){
    return `
    This project is licensed under the GNU GPLv3 license. To abtain a copy of the license, visit:
    
    ${renderLicenseLink(license)}`;
  
  } else if (data.license === 'ISC'){
    return `
    This project is licensed under the ISC license. To abtain a copy of the license, visit:
    
    ${renderLicenseLink(license)}`;

  } else if (data.license === 'The Unlicense'){
    return `
    This project is licensed under the The Unlicense license. To abtain a copy of the license, visit:
